...
export const addNewCartSuccess = createAction('[Cart] Create New Cart Success', props<{cart: Cart}>());
...
export const addProductToCartSuccess = createAction('[Cart] Add Product To Cart Success', props<{cart: Cart}>());
